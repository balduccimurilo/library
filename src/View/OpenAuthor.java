 ...
 * @author dneDa
 */
public class OpenAuthor extends javax.swing.JFrame {
    ...
    private void popularTabelaAutores(List<Authors> pListaDeAuthors){
        ...
        jTableListar.setModel(modeloAuthors);
        for(Authors authors: pListaDeAuthors){
            if(authors.getName().toUpperCase().contains(jTextFieldNome.getText().toUpperCase())){
                if(authors.getAuthor_id().toString().contains(jTextFieldId.getText())){
...
// TODO add your handling code here:
    ...
    private void jButtonIncluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonIncluirActionPerformed
        ...
        for(Authors authors: listaAuthors){
            if(String.valueOf(modeloTabelaAuthors.getValueAt(linha, 2)).equals(String.valueOf(authors.getAuthor_id()))){
                this.authors=authors;
            }            
        }

        telaPrincipal.AdicionarAutor(authors);
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(OpenAuthor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new OpenAuthor().setVisible(true);
            }
        });
    }
